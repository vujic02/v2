  ...
  return (
    <Container flexDir="column" align="center" p="200px 0 400px 0" alignText="center" ref={(el) => (textRef = el)}>
      ...
      <P col={false} maxW={true}>
        I'm a 23-year-old Web developer based in Stara Pazova, Serbia. I'm deeply passionate about crafting visually appealing and dynamic websites, utilizing the latest
